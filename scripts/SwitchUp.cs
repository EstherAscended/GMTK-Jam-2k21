...
public class SwitchUp : Node2D
{
    ...
    private PackedScene tileJunctionDown0 = GD.Load<PackedScene>("res://scenes/tracks/Junction/Up/TileJunctionUp0.tscn");
    private PackedScene tileJunctionDown1 = GD.Load<PackedScene>("res://scenes/tracks/Junction/Up/TileJunctionUp1.tscn");
    private PackedScene tileJunctionDown2 = GD.Load<PackedScene>("res://scenes/tracks/Junction/Up/TileJunctionUp2.tscn");
